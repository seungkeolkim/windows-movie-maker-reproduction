...
| `E-MEDIA-CACHE-REGENERATE` | 1.0 | 선택 항목의 썸네일·파형·프록시 캐시를 안전하게 다시 생성 | 실제 정상 미디어에서만 활성화 | `F-MEDIA-09` |
...
| 상호작용 | 입력 | 활성 조건 | 즉시 결과 | 연결 기능 |
| --- | --- | --- | --- | --- |
| `I-PREVIEW-TOGGLE` | 재생 버튼, `Space` | 프로젝트 길이 > 0, 텍스트 입력 중 아님 | 단조 시계 기반 시간 진행과 실제 프레임 갱신 | `F-PREVIEW-02` |
...
| `E-AUDIO-WAVEFORM` | 1.0 | 실제 디코딩 샘플의 결정적 min/max 파형과 생성 상태 | `F-AUDIO-05`, `F-MEDIA-09` |
