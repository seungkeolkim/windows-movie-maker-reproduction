...
코어, W-02 실제 미디어 보관함, W-03 프로젝트 저장·열기와 W-04 타임라인 편집까지 구현되어
있습니다. 로컬 영상·사진·오디오를 분석해 고정 트랙에 추가하고, 클립 이동·삭제·분할·트리밍,
사진 길이와 영상 속도 변경을 실행 취소·다시 실행할 수 있습니다. 결과는 `schema_version`이
있는 UTF-8 JSON 파일에 원자적으로 저장됩니다. 실제 미디어 재생과 MP4 출력은 아직 목업입니다.
...
| 재생·렌더링 서비스 | W-05 실제 미리 보기 시간축과 디코딩이 다음 작업, 출력은 후속 작업 |
| 첫 사용 가능 버전 | 미배포 |
